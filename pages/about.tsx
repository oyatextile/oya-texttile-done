  ...
  return (
    <VStack bg="white" color="black" w="100%">
      <Box w="full" h="md" display="flex" pos={'relative'}>
        ...
        />
        <Heading marginTop="auto" bg="white" p="4" 
          pos={'absolute'}
          bottom='0'
        >
          About company
      ...
      >
        ...
        >
          ...
          <Text fontSize="14">
            ...
            trustworthy manufacturer, we are committed to deliver products that
            meet their needs and their market requirements in terms of quality,
            finishing and eventually reasonable, competitive prices.
          </Text>
          <Text fontSize="14">
            Products produced in our facility are the flagship of our company,
            we adapted a transparent easy-to-follow concept to help clients have
            the big picture of the manufacturing, exporting process that
      ...
      >
        ...
        <Text alignSelf="center" w={{ base: "full", lg: "xl" }}>
          ...
          follows the international standards, we are certified with most known
          and retuable Textile Certification so that our clients collaborate
          with us while they are certain of the origine of the products.
        </Text>
      </Stack>
      <hr />
      <Stack
